...
const StudentDetailsScreen = () => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#1a1a1a' }}>
            ...
            <View
                style={{
                    height: isDesktop ? 80 : 'auto',
                    paddingTop: isDesktop ? 0 : 60,
                    paddingBottom: isDesktop ? 0 : 20,
                    backgroundColor: '#1b1b1b', // Match sidebar
                    borderBottomWidth: 1,
                    borderBottomColor: '#2c2c2c',
                    width: '100%',
                    alignItems: 'center', // Center content like the body
            ...
            >
                <View style={[{
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 16 }}>
                        ...
                        {isDesktop && (
                            <Text style={{ fontSize: 24, fontWeight: '800', color: '#fff' }}>{t('student_profile_title')}</Text>
                        )}
                    </View>
                    ...
                    >
                        ...
                        {isDesktop && (
                            <Text style={{ color: '#fff', fontWeight: '600' }}>{t('send_message') || 'Send Message'}</Text>
                        )}
                    </TouchableOpacity>
                </View>
            </View>

            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingVertical: 24, alignItems: 'center' }}>
                <View style={[isDesktop ? { flexDirection: 'row', alignItems: 'flex-start', gap: 32 } : { width: '100%' }, containerStyle]}>
                    {/* Sidebar / Profile Card */}
                    <View style={isDesktop ? { width: 380 } : { width: '100%' }}>
                        ...
                        <View style={{
                            ...
                            <Text style={{ fontSize: 24, fontWeight: '800', color: '#fff', marginBottom: 6, textAlign: 'center' }}>
                                {student.name}
                            </Text>
                            <Text style={{ fontSize: 15, color: '#bdc3c7', marginBottom: 24, textAlign: 'center' }}>
                                {student.email}
                            </Text>

                            <View style={{ flexDirection: 'row', gap: 12, flexWrap: 'wrap', justifyContent: 'center' }}>
                                <View style={{ backgroundColor: 'rgba(52, 152, 219, 0.1)', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(52, 152, 219, 0.3)' }}>
                                    <Text style={{ color: '#3498db', fontSize: 13, fontWeight: '700' }}>ID: #{student.id}</Text>
                                </View>
                                <View style={{ backgroundColor: 'rgba(46, 204, 113, 0.1)', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(46, 204, 113, 0.3)' }}>
                                    <Text style={{ color: '#2ecc71', fontSize: 13, fontWeight: '700' }}>{student.intakes.length} {t('intakes_label')}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                    ...
                    {/* Main Content Area */}
                    <View style={{ flex: 1 }}>
                        <Text style={{ fontSize: 20, fontWeight: '800', color: '#fff', marginBottom: 20 }}>
                        ...
                        {student.intakes.length === 0 && (
                            <View style={{ alignItems: 'center', paddingVertical: 60, opacity: 0.5, backgroundColor: '#252525', borderRadius: 20, borderWidth: 1, borderColor: '#333' }}>
